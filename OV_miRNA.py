...
#miRNA = pd.read_csv('miRNA_2.csv',delimiter=',')
    ...
    for n, (real_samples, _) in enumerate(miRNA_train_loader):
        ...
        if epoch ==0:
           ...
           # sys.exit()
            ...
            #sys.exit()
            if pred==1:
              filename = '/home/tahmed/OmicsGAN/OV/stage_miRNA_'+str(update)+'.csv'
            else:
              filename = '/home/tahmed/OmicsGAN/OV/miRNA_all'+str(update)+'.csv'
