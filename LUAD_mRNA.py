...
def FILENAME(update,clf_ind,pred):
  if pred==1:
    filename = '/home/tahmed/OmicsGAN/LUAD/stage_mRNA_'+clf_ind+'_'+str(update)+'.csv'
  else:
    filename = '/home/tahmed/OmicsGAN/LUAD/mRNA_all'+clf_ind+'_'+str(update)+'.csv'
...
#mRNA = pd.read_csv('mRNA_linear_5.csv',delimiter=',')
